...
<body>
    ...
    <div class="success-message">
        ...
        <button onclick="this.parentElement.remove()" style="background:none;border:none;color:white;font-size:1.2rem;cursor:pointer;padding:0 8px;">&times;</button>
    </div>
    @endif
    ...
    <div class="post-column">
        <div class="left-content">
                ...
                <div class="post-content-wrapper">
                    <div class="post-top">
                        <div class="post-author-info">
                            @if($post->user->photo)
                            <img src="{{ asset('storage/' . $post->user->photo) }}" alt="{{ $post->user->name }}" class="profile-pic">
                            @else
                            <div class="profile-pic-default">{{ strtoupper(substr($post->user->name, 0, 1)) }}</div>
                            @endif
                            <small>
                    ...
                    <div id='post-content-container' class="post-content" style='display:block;'>
                        ...
                        <div class="post-bottom">
                            ...
                            @endif
                            <button type="button" class='comment-toggle-btn' id='comment-toggle-btn'>Comment</button>
            ...
            <div id='comment-column' class='comment-column'>
                <div class="create-comment-form" id="create-comment-form" style="display:none;">
                ...
                <div class="comment" id='comment-{{ $comment->id }}'>
                    <div class="comment-collapse-line" onclick="toggleCommentCollapse({{ $comment->id }})"></div>
                    <div class='comment-top'>
                        <div class="comment-author-info">
                            @if($comment->user->photo)
                            <img src="{{ asset('storage/' . $comment->user->photo) }}" alt="{{ $comment->user->name }}" class="profile-pic-small">
                            @else
                            <div class="profile-pic-small-default">{{ strtoupper(substr($comment->user->name, 0, 1)) }}</div>
                            @endif
                ...
                <div class="reply-container" id='reply-container-{{ $comment->id }}' style='display:none;' data-has-replies='{{ $comment->replies_count > 0 ? "true" : "false" }}' data-expanded='false'></div>
                @endforeach
            </div>
        </div>
            ...
            <div class="reply">
                ...
                <div class="reply-top">
                    <div class="reply-author-info">
                        <div class="profile-pic-reply"></div>
